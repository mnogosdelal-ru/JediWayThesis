...
**Дата генерации:** 2026-04-06 13:53
...
### H7a: Линейная регрессия — предсказание по трём зонам

Линейная регрессия: MBI, Прокрастинация и SWLS предсказываются числом всех трёх кубиков (🔴, 🟢, ⚪)
...
| Выборка | n | Показатель | R² | β₀ | β₁(🔴) | p(🔴) | β₂(🟢) | p(🟢) | β₃(⚪) | p(⚪) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Полная | 231 | MBI | 0.135 | 31.00 | -0.238 | 0.8692 | -3.343 | 0.0206* | -0.237 | 0.8688 |
| Полная | 231 | Прокрастинация | 0.136 | 0.00 | 5.073 | 0.0000*** | 2.986 | 0.0110* | 4.790 | 0.0001*** |
| Полная | 231 | SWLS | 0.088 | -0.00 | 3.699 | 0.0009*** | 4.553 | 0.0000*** | 3.042 | 0.0060** |
| Почти типовая (−1..1) | 154 | MBI | 0.159 | 31.00 | -0.227 | 0.8689 | -3.487 | 0.0117* | -0.477 | 0.7278 |
| Почти типовая (−1..1) | 154 | Прокрастинация | 0.195 | 0.00 | 5.224 | 0.0000*** | 2.731 | 0.0200* | 4.869 | 0.0000*** |
| Почти типовая (−1..1) | 154 | SWLS | 0.091 | -0.00 | 3.700 | 0.0019** | 4.414 | 0.0002*** | 3.208 | 0.0066** |
| Точно типовая (0) | 60 | MBI | Ошибка | — | — | — | — | — | — | — |
| Точно типовая (0) | 60 | Прокрастинация | Ошибка | — | — | — | — | — | — | — |
| Точно типовая (0) | 60 | SWLS | Ошибка | — | — | — | — | — | — | — |
...
- Полная, MBI: R²=0.135, значимые: 🟢

- Полная, Прокрастинация: R²=0.136, значимые: 🔴, 🟢, ⚪

- Полная, SWLS: R²=0.088, значимые: 🔴, 🟢, ⚪

- Почти типовая (−1..1), MBI: R²=0.159, значимые: 🟢

- Почти типовая (−1..1), Прокрастинация: R²=0.195, значимые: 🔴, 🟢, ⚪

- Почти типовая (−1..1), SWLS: R²=0.091, значимые: 🔴, 🟢, ⚪
