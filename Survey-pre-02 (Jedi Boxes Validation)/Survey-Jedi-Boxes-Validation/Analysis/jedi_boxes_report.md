...
**Дата генерации:** 2026-04-06 14:06
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Полная | 231 | MBI | 0.135 | 29.68 | -0.026 | 0.9687 | -3.131 | 0.0000*** |
| Полная | 231 | Прокрастинация | 0.072 | 26.75 | 0.799 | 0.1535 | -1.306 | 0.0153* |
| Полная | 231 | SWLS | 0.057 | 16.99 | 0.985 | 0.0573 | 1.827 | 0.0003*** |
| Почти типовая (−1..1) | 154 | MBI | 0.158 | 28.45 | 0.168 | 0.8295 | -3.090 | 0.0001*** |
| Почти типовая (−1..1) | 154 | Прокрастинация | 0.101 | 26.03 | 1.195 | 0.0889 | -1.324 | 0.0513 |
| Почти типовая (−1..1) | 154 | SWLS | 0.045 | 17.15 | 1.045 | 0.1248 | 1.742 | 0.0086** |
| Точно типовая (0) | 60 | MBI | 0.303 | 26.24 | 2.183 | 0.0890 | -3.101 | 0.0090** |
| Точно типовая (0) | 60 | Прокрастинация | 0.280 | 26.85 | 2.061 | 0.0762 | -2.498 | 0.0192* |
| Точно типовая (0) | 60 | SWLS | 0.140 | 17.14 | 0.285 | 0.7911 | 2.519 | 0.0121* |
...
- Полная, Прокрастинация: R²=0.072, значимые: 🟢

- Полная, SWLS: R²=0.057, значимые: 🟢

- Почти типовая (−1..1), MBI: R²=0.158, значимые: 🟢

- Почти типовая (−1..1), Прокрастинация: R²=0.101, значимые: нет значимых

- Почти типовая (−1..1), SWLS: R²=0.045, значимые: 🟢

- Точно типовая (0), MBI: R²=0.303, значимые: 🟢

- Точно типовая (0), Прокрастинация: R²=0.280, значимые: 🟢

- Точно типовая (0), SWLS: R²=0.140, значимые: 🟢
