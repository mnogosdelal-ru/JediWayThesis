...
> [!NOTE]
> В этой таблице представлены нагрузки на первые 5 факторов до применения вращения. Первый фактор (F1) здесь отражает общее ядро шкалы (General Factor), по которому отбирались пункты для MIS-4.
...
# Краткая версия шкалы (MIS-4)

Размер шкалы: 4 пунктов.
...
- **Альфа Кронбаха: 0.936**
- **Омега Макдональда: 0.936**
- **Средняя межпунктовая корреляция: 0.785**
- **Доля дисперсии (PCA F1): 83.9%**
- **Мера адекватности выборки KMO: 0.850**
...
| | MIS_q_28 | MIS_q_24 | MIS_q_16 | MIS_q_26 |
|---|---|---|---|---|
| **MIS_q_28** | 1.000 | 0.798 | 0.787 | 0.828 |
| **MIS_q_24** | 0.798 | 1.000 | 0.749 | 0.822 |
| **MIS_q_16** | 0.787 | 0.749 | 1.000 | 0.728 |
| **MIS_q_26** | 0.828 | 0.822 | 0.728 | 1.000 |

### Пункты short и их характеристики:

| # | Текст пункта | Mean | SD | r-total | α-deleted |
|---|---|---|---|---|---|
| 28 | Я чувствую, что мои ресурсы (время и энергия) исчерпываются на срочное | 3.12 | 1.43 | 0.876 | 0.907 |
| 24 | Срочные дела мешают мне развиваться в нужном мне направлении | 2.92 | 1.38 | 0.854 | 0.914 |
| 16 | Я живу в режиме "тушения пожаров" большую часть времени | 2.71 | 1.45 | 0.806 | 0.930 |
| 26 | Мой потенциал не реализуется из-за необходимости постоянно реагировать на срочное | 2.89 | 1.41 | 0.858 | 0.913 |
...
|---|---|---|---|
| Планомерность | -0.453 | -0.441 | 97.3% |
| Целеустремленность | -0.335 | -0.343 | 102.4% |
| Настойчивость | -0.514 | -0.490 | 95.2% |
| Фиксация на структурировании | 0.476 | 0.458 | 96.2% |
| Самоорганизация | -0.125 | -0.109 | 87.3% |
| Ориентация на настоящее | -0.157 | -0.153 | 97.1% |
| ОСД Итого | -0.396 | -0.386 | 97.6% |
| single_item | -0.751 | -0.715 | 95.1% |
...
| MIS_short | -0.441*** | -0.343*** | -0.490*** | 0.458*** | -0.109 | -0.153 | -0.386*** | -0.715*** |
